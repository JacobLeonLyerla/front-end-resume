        ...
        <Col md="8" lg="8" className="progress-styles">
          ...
          <Row>
            <Col sm="12" md="12" lg="6" xl="12" className="card-styles">
              ...
              <Card
                className={`card${props.index + 1} ${props.gif}${props.index +
                  1} `}
                id="test"
              >
                <div>
              ...
              <ListGroup>
                <div className="links">
                  <a className="link-styles" target="_blank" href={props.project.webpage}>
                    <ListGroupItem>View Deployed Site</ListGroupItem>
                  </a>
                  <a className="link-styles" target="_blank" href={props.project.youtube}>
                    {" "}
                    <ListGroupItem>
                  ...
                  <a className="link-styles" target="_blank" href={props.project.github}>
